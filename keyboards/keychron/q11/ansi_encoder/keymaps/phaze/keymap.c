...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_91_ansi(
        ...
        _______,  KC_CAPS,  GUI_A,     ALT_S,     SFT_D,     CTL_F,     KC_G,      KC_H,     CTL_J,     SFT_K,     ALT_L,     GUI_SCLN,  KC_QUOT,              KC_ENT,             KC_HOME,
        _______,  KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,      KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,
        _______,  KC_LCTL,  KC_LGUI,  KC_LALT,  TT(FN),         KC_SPC,                        KC_SPC,             KC_RALT,  TT(FN), KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [GAME] = { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(KC_VOLD, KC_VOLU) },
};
